---
description: Red Lettuce Leaves 1 ; Lactuca sativa
meta_title:
title: RLL1
...
## Gene Details:
- **Gene ID:**	[]()
- **Gene Symbol:** <u> RLL1 </u>
- **Gene Name:** Red Lettuce Leaves 1
...
## Functional Descriptions:
   ...
   - The **RLL1** gene encodes a bHLH transcription factor, and a 5-bp deletion in some cultivars abolishes its function to activate the anthocyanin biosynthesis pathway.
   - The mutations in **RLL1** disrupt anthocyanin biosynthesis, while the mutations in RLL2, rll3 and rll4 activate anthocyanin biosynthesis, showing disruptive selection for leaf colour during domestication of lettuce. 
