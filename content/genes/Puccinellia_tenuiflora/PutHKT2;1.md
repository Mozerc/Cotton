...
## Functional Description:
   - these findings demonstrate that the functional activity of PutHKT**1**;5 and PutSOS**1** in P. tenuiflora roots is fine-tuned under saline conditions as well as by operation of other ion transporters/channel (PutHKT**1**;4, **PutHKT2**;**1**, and PutAKT**1**).
