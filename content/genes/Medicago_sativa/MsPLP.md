...
tags: [ leaf,development,leaf development,vegetative ]
---

## Gene Details:
- **Gene ID:**	[]()
- **Gene Symbol:** <u> MsPLP </u>
- **Gene Name:** 
- **Genome:** []()
...
## Functional Descriptions:
   ...
   - Functional characterization of PETIOLULE-LIKE PULVINUS (**MsPLP**) gene in abscission zone development in Medicago truncatula and its application to genetic improvement of alfalfa.
   - Suppression of **MsPLP** strengthens the leaflet and petiole pulvinus region.
   - The results show that down-regulation of **MsPLP** has no impact on alfalfa nutritive value when the vegetative plants were gently harvested without leaf loss.

## Function-related keywords:
   - [leaf](/tags/leaf/),&nbsp;&nbsp;[development](/tags/development/),&nbsp;&nbsp;[leaf-development](/tags/leaf-development/),&nbsp;&nbsp;[vegetative](/tags/vegetative/)
