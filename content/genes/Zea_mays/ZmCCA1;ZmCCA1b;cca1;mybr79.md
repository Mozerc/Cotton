...
## Functional Description:
   - A detailed study of **Zm**cca1**** and ZmTOC1 confirmed that they are the key components in the maize circadian clock.
   - **Zm**cca1**** encodes FLAVIN-BINDING, KELCH REPEAT, F-BOX1, is essential for photoperiodic-specific light signalling.
