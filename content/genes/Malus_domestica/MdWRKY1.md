...
## Functional Descriptions:
   ...
   - **MdWRKY1**–MdLNC499–MdERF109 transcriptional regulatory cascade that orchestrates fruit coloration.
   - **MdWRKY1** overexpression resulted in increased anthocyanin accumulation compared with the control calli, and we observed no obvious difference between the control and RNAi calli.
