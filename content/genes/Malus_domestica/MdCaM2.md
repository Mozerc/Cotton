---
description: MD14G1092700 ; Malus domestica
meta_title:
title: MdCaM2
categories: [Malus domestica]
tags: [ signal transduction,calcium ]
---

## Gene Details:
- **Gene ID:**	[MD14G1092700]()
- **Gene Symbol:** MdCaM2
- **Gene Name:** 
...
## Functional Descriptions:
   - CaM is ubiquitous in eukaryotic cells, where it binds calcium ions and participates in signal transduction.These results consistently indicated that the putative MdCRF4 CaMBD indeed mediates an interaction between MdCRF4 and **MdCaM2**.
   - These results indicated that Ca2+ enhances the interaction between **MdCaM2** and MdCRF4.
   - CaM2 senses Ca2+ and interacts with MdCRF4.

## Function-related keywords:
   - [signal-transduction](/tags/signal-transduction/)&nbsp;,&nbsp;[calcium](/tags/calcium/)
